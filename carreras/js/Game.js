class Game {
  ...
  start() {
    ...
    // Agregando el sprite de combustible al juego
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //utiliza datos de la base de datos para mostrar los autos en la direcció x e y
  ...
  handleFuel(index) {
    ...
    cars[index - 1].overlap(fuels, function(collector, collected) {
      player.fuel = 185;
      //recolectado esta el sprite en el grupo de recolectables que activaron
      //el evento
      collected.remove();
    });
  }
